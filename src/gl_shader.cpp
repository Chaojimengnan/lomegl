...
gl_shader::gl_shader() : shader_program_(gl_val_factory(gl_val_type::program)),
                         vertex_shader_(gl_val_factory(0, gl_val_type::vertex_shader)),
                         fragment_shader_(gl_val_factory(0, gl_val_type::fragment_shader)),
                         geometry_shader_(gl_val_factory(0, gl_val_type::geometry_shader))
{
